...
class RichBlockExpandableBlockQuotation(Object):
    """A block quotation, which can be expanded or collapsed back, corresponding to the HTML tag <blockquote> with custom attribute "collapsed".
